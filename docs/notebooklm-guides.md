# NotebookLM Official Practical Guides & Multi-language Documentation Index

> **Notice & Operational Disclaimer**:  
> The documents listed below are **official practical connection and configuration guides** compiled and published by the Hajiyun team using Google NotebookLM.  
> - **Not Independent Benchmarks**: These materials are intended for user setup and operational guidance; they do not constitute third-party evaluations, independent comparative reviews, or performance benchmarks.  
> - **No Google Endorsement**: The hosting and compilation on Google NotebookLM does not imply any official endorsement, sponsorship, or certification by Google.  
> - **Dynamic Model Availability & Pricing**: Supported models, tier quotas, and token pricing are updated dynamically. Please always consult your live [Hajiyun Console](https://hajiyun.top) for authoritative model lists and current rates.

---

## 📚 Multi-language Connection & Troubleshooting Guides

### 1. 🇯🇵 Japanese Guide / 日本語接続・設定ガイド
